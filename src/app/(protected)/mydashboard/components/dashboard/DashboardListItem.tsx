...
const DashboardListItem = ({ dashboard, members }: DashboardListItemProps) => {
  ...
  return (
    <div
      ...
      className="group dark:bg-taskify-black-400 relative flex min-h-[58px] w-full max-w-[290px] cursor-pointer flex-col items-start justify-between gap-2 rounded-lg border p-4 transition hover:shadow-sm md:min-h-[68px] md:w-full md:max-w-[275px] md:flex-row lg:min-h-[165px] lg:w-[165px] lg:flex-col"
    >
