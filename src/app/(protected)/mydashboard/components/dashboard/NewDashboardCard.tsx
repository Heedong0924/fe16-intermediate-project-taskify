...
const NewDashboardCard = () => {
  ...
  return (
    <div
      ...
      className="dark:bg-taskify-black-400 order-0 flex min-h-[58px] w-full max-w-[290px] cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border p-3 transition hover:shadow-sm md:min-h-[68px] md:w-full md:max-w-[275px] lg:min-h-[165px] lg:w-[165px]"
    >
