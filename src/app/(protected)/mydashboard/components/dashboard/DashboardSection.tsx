...
const DashboardSection = () => {
  ...
  if (isPending) {
    return (
      <div className="dark:bg-taskify-black-400 bg-taskify-neutral-0 mb-10 flex h-[550px] w-full max-w-[330px] flex-col rounded-2xl p-6 px-[15px] md:mt-3 md:h-[360px] md:w-full md:max-w-[620px] lg:mt-5 lg:h-[330px] lg:w-full lg:max-w-[1022px]">
        <h1 className="text-taskify-2xl-bold dark:text-taskify-gray-800 text-taskify-neutral-700 mb-6 md:ml-4 lg:ml-4">
          대시보드
        </h1>
