...
function Test() {
  ...
  return (
    <div>
      ...
      <UserProfile size="sm" profileImg="잘못된주소" userName="홍길동" />
      <UserProfile size="md" profileImg="" userName="김민수" />
      <UserProfile size="lg" userName="kara" />
      <h1 className="text-xl font-bold">AvatarProfile (아바타)</h1>
      <p>
        영어 이름에 경우 대문자로 나옵니다. <br /> 색상은 랜덤
      </p>
      <AvatarProfile size="sm" userName="박연희" />
      <AvatarProfile size="md" userName="2팀" />
      <AvatarProfile size="lg" userName="Alice" />
      <hr />
      ...
      <CounterChip> 1</CounterChip>
      <CounterChip> 45</CounterChip>
